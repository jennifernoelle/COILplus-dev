...
#'
#' @param log1m_pipj Optional matrix of dimension `n_i x n_j`. Precomputed
#'   values of `log(1 - probobs_curr_i * probobs_others_j)`. If `NULL`,
#'   computed internally from `probobs_curr` and `probobs_others`.
