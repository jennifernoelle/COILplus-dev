...
# Paths to bundled raw data
data_path <- system.file("extdata", package = "COILplus")

# Where to save processed data (set your own path for a real analysis)
save_path <- file.path(system.file("extdata", package = "COILplus"), "processed")
...
```{r load}
frug <- read.csv(file.path(data_path, "frug_generic.csv"))
```
...
```{r sort}
load(file.path(data_path, "Cu_phylo.dat"))
load(file.path(data_path, "Cv_phylo.dat"))
load(file.path(data_path, "Obs_X.dat"))
load(file.path(data_path, "Obs_W.dat"))
v.taxa <- read.csv(file.path(data_path, "v_taxa_generic.csv"))
p.taxa <- read.csv(file.path(data_path, "p_taxa_generic.csv"))
...
```{r save}
if (save_files) {
  save(obs_A,     file = file.path(save_path, "A_obs.dat"))
  save(O_P,       file = file.path(save_path, "OP_full.dat"))
  save(O_V,       file = file.path(save_path, "OV_full.dat"))
  save(obs_F,     file = file.path(save_path, "F_obs.dat"))
  save(Cu_sorted, file = file.path(save_path, "Cu_phylo_sorted.dat"))
  save(Cv_sorted, file = file.path(save_path, "Cv_phylo_sorted.dat"))
  save(obs_X,     file = file.path(save_path, "Obs_X_sorted.dat"))
  save(obs_W,     file = file.path(save_path, "Obs_W_sorted.dat"))
  write.csv(v.taxa.sorted, file.path(save_path, "v_taxa_sorted.csv"), row.names = FALSE)
  write.csv(p.taxa.sorted, file.path(save_path, "p_taxa_sorted.csv"), row.names = FALSE)
}
```
