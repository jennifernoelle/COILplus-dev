# This file runs COIL+ across four chains using: 
  ...
  # Legacy function with unblocked sampling of occurrence probabilities and indicators
  # This function is computationally less efficient but distributionally equivalent
...
start_values <- NULL
block_sampleOccP <- FALSE # Unblocked sampling of occurrences, probabilities
